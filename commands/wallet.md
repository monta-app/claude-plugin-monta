...
6. Flag transactions in a non-completed `state` older than 24 hours and any negative balance. Offer the reconciliation workflow from `monta-charging-operations` to match transactions against charges. Do not post adjustments from this command.
